...
function Kong.header_filter()
  ...
  execute_plugins_iterator(runloop.get_plugins_iterator(), ctx, "header_filter")
...
function Kong.body_filter()
  ...
  execute_plugins_iterator(runloop.get_plugins_iterator(), ctx, "body_filter")
...
function Kong.log()
  ...
  execute_plugins_iterator(runloop.get_plugins_iterator(), ctx, "log")
